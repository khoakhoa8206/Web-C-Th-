...
import type { FlashVocab } from "./flashcard-component";

export function VocabReviewStep({
  vocabList,
  onReady,
  stepError,
}: {
  ...
  return (
    <div className="min-h-screen bg-pink-50 pb-24">
      <div className="max-w-2xl mx-auto px-4 pt-6">
        <div className="text-center mb-6">
          ...
          <h1 className="text-lg font-bold text-slate">
            Ôn lại từ vựng trước khi làm bài
          </h1>
        ...
        <div className="bg-white rounded-2xl border border-surface-border overflow-hidden">
          <div className="grid grid-cols-3 gap-0 border-b border-surface-border bg-pink-50 px-4 py-2">
            <p className="text-xs font-bold text-slate/60 uppercase tracking-wide">
              Từ vựng
            </p>
            <p className="text-xs font-bold text-slate/60 uppercase tracking-wide">
              Nghĩa
      ...
      <div className="fixed bottom-6 right-6">
        <Button variant="primary" onClick={onReady} className="shadow-card-hover">
          SẴN SÀNG LÀM BÀI →
        </Button>
      </div>
    </div>
