  ...
  return (
    <div className="min-h-screen bg-pink-50 flex items-center justify-center p-6">
      <div className="w-full max-w-md text-center">
        ...
        <p className="text-sm text-slate-600 mb-8">Bạn đang truy cập với vai trò nào?</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <CardContainer hoverable onClick={() => navigate("/student")} className="py-8">
            ...
            <p className="text-xs text-slate-600 mt-1">Vào học từ vựng</p>
          </CardContainer>

          <CardContainer hoverable onClick={() => navigate("/teacher")} className="py-8" tone="tinted">
            <p className="text-3xl mb-2">🧑‍🏫</p>
            <p className="font-bold text-slate">Giáo viên</p>
            <p className="text-xs text-slate-600 mt-1">Dashboard quản lý lớp học</p>
          </CardContainer>
        </div>
      </div>
    </div>
